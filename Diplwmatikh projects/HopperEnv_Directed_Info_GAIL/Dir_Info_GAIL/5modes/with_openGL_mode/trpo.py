...
class TRPOAgent(object):
    ...
    def run(self, episode_num, vae=False, bcloning=False, fname='0%_validate'):
        if vae:
            ...
            out_file = myconfig['output_dir']+'/exp'+str(myconfig['exp'])+'_'+fname+'_D-Info_GAIL_results-5modes.csv'
            action_out_file = myconfig['output_dir'] + '/exp'+str(myconfig['exp'])+'_'+fname+'_D-Info_GAIL_actions_results-5modes.csv'
