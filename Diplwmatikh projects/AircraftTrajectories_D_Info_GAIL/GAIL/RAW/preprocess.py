...
if args.split_dataset:
    ...
    obs_train = train_validation_set_df[['trajectory_ID','longitude','latitude','altitude','timestamp']]
    obs_test = test_set_df[['trajectory_ID','longitude','latitude','altitude','timestamp']]
...
agent = trpo.TRPOAgent(env, action_dimensions=3, observation_dimensions=4)
