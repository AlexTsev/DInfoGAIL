...
def unnormalize_action(action):
    action1 = action[0] * myconfig['action1_std'] + myconfig['action1_avg']
    action2 = action[1] * myconfig['action2_std'] + myconfig['action2_avg']
    action3 = action[2] * myconfig['action3_std'] + myconfig['action3_avg']
